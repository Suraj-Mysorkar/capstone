...
const STATUSES = ['ALL', 'APPROVED', 'REJECTED', 'MANUAL_REVIEW_REQUIRED', 'DOCUMENT_REVIEW_PENDING', 'SUBMITTED'];
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>Amount</th><th>Tenure</th><th>EMI</th><th>Status</th><th>Applied</th>
                </tr>
              </thead>
              <tbody>
                {apps.map((a) => (
